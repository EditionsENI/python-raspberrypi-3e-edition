...
import os
import sys
from tkinter import Frame, Menu, Label, TclError, X
from tkinter import END, SEL, SEL_LAST, SEL_FIRST, INSERT
from tkinter import YES, BOTH, BOTTOM, WORD, SUNKEN, TOP
...
class PiDiteur(Frame):
    ...
    def quitter(self):
        if askyesno("Confirmation", f"Voulez-vous vraiment fermer {self.nom_editeur} ?"):
            Frame.quit(self)
